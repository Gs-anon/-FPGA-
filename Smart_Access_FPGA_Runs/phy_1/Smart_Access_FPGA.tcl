...
set rc [catch {
  ...
  import_db {../syn_1/Smart_Access_FPGA_gate.db}
  place
  export_db {Smart_Access_FPGA_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file Smart_Access_FPGA_phy.area
  export_db {Smart_Access_FPGA_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid Smart_Access_FPGA_inst.bid
  bitgen -bit "Smart_Access_FPGA.bit" -unused_io_status pulldown
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
